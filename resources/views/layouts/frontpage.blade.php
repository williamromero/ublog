...
<head>
    ...
    <title>{{ config('app.name') }} :: Psicología</title>
...
<body>
  ...
  <div class="main-slider-container col-xs-12 col-md-12">
    <div class="row">
  ...
  <section class="footer">
      <footer>
          <div class="container">
              ...
              <p>&copy; {{ $today->year }} - Central America  <span class="c-white">&#124; Webres Studio</span></p>
              <!--
